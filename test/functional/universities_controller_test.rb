...
class UniversitiesControllerTest < ActionController::TestCase
  ...
  test "should create university" do
    assert_difference('University.count') do
      post :create, university: { unicode: @university.unicode, uniname: @university.uniname, uniwebsite: @university.uniwebsite }
    end
  ...
  test "should update university" do
    put :update, id: @university, university: { unicode: @university.unicode, uniname: @university.uniname, uniwebsite: @university.uniwebsite }
    assert_redirected_to university_path(assigns(:university))
  end
